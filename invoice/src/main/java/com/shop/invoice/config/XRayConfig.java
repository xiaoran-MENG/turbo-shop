...
public class XRayConfig {
    ...
    public XRayConfig() {
        try {
            ...
            var strategy = new CentralizedSamplingStrategy(configFle);
            var recorder = AWSXRayRecorderBuilder.standard()
                    .withDefaultPlugins()
                    .withSamplingStrategy(strategy)
                    .build();
    ...
    public Filter tracingFilter() {
        return new AWSXRayServletFilter("invoice-segment");
    }
}
